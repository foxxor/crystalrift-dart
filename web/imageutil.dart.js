...
// Native classes
// Bound closures
$$.Bound__completeError__Future = [P, {"": "BoundClosure;_self,_liblib$_target,_receiver",
...
$$.BoundClosure$0 = [P, {"": "BoundClosure;_self,_liblib$_target,_receiver",
  call$0: function() {
    return this._self[this._liblib$_target]();
  }
}];

$$.BoundClosure$1 = [P, {"": "BoundClosure;_self,_liblib$_target,_receiver",
  call$1: function(p0) {
...
$$.Closure$mousePressed = [X, {"": "Closure;call$1,$name"}];
...
ConstantMap: {"": "Object;length>,_jsObject,_liblib$_keys",
  ...
  forEach$1: function(_, f) {
    J.forEach$1$ax(this._liblib$_keys, new H.ConstantMap_forEach_closure(this, f));
  },
  get$keys: function() {
    return new H._ConstantMapKeyIterable(this);
  },
  get$values: function(_) {
    return J.map$1$ax(this._liblib$_keys, new H.ConstantMap_values_closure(this));
  },
...
_ConstantMapKeyIterable: {"": "IterableBase;_liblib$_map",
  get$iterator: function(_) {
    return J.get$iterator$ax(this._liblib$_map._liblib$_keys);
  }
},
...
BoundClosure: {"": "Closure;_self,_liblib$_target,_receiver",
  ...
  get$hashCode: function(_) {
    return J.get$hashCode$(this._self) + J.get$hashCode$(this._liblib$_target) + J.get$hashCode$(this._receiver) & 0x3ffffff;
  },
  $isBoundClosure: true
},
...
MappedListIterable: {"": "ListIterable;_liblib2$_source,_f",
  _f$1: function(arg0) {
    return this._f.call$1(arg0);
  },
  get$length: function(_) {
    return J.get$length$asx(this._liblib2$_source);
  },
  elementAt$1: function(_, index) {
    return this._f$1(J.elementAt$1$ax(this._liblib2$_source, index));
  },
...
_ForwardingStreamSubscription: {"": "_BufferingStreamSubscription;_stream,_subscription,_liblib1$_onData,_onError,_onDone,_zone,_state,_pending",
  _liblib1$_add$1: function(data) {
    if ((this._state & 2) !== 0)
      return;
    P._BufferingStreamSubscription.prototype._liblib1$_add$1.call(this, data);
  },
  _addError$1: function(error) {
    if ((this._state & 2) !== 0)
      return;
...
_IdentityHashMap: {"": "_HashMap;_liblib0$_length,_strings,_nums,_rest,_keys",
  _findBucketIndex$2: function(bucket, key) {
    var $length, i, t1;
    if (bucket == null)
      return -1;
...
_CustomHashMap: {"": "_HashMap;_equals,_hashCode,_validKey,_liblib0$_length,_strings,_nums,_rest,_keys",
...
RectBase: {"": "Object;",
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !t1.$isRect)
      return false;
    if (this.get$left() === other.left)
      if (this.get$top(this) === other.top) {
  ...
  get$hashCode: function(_) {
    ...
    t2 = this.get$top(this) & 0x1FFFFFFF;
...
InputElement: {"": "HtmlElement;height%,src},width%"},
...
UIEvent: {"": "Event;_pageX:pageX=,_pageY:pageY=",
  get$pageX: function(receiver) {
    return new W.Point(receiver.pageX, receiver.pageY).x;
  }
},
...
FEColorMatrixElement: {"": "SvgElement;height=,width="},
...
FETurbulenceElement: {"": "SvgElement;height=,width="},
...
["imageutil.dart", "imageutil.dart", , X, {
main: function() {
  var t1, t2;
  $._doc = window.document;
  $.canvas = $._doc.querySelector("#canvas");
  $._ctx = J.getContext$1$x($.canvas, "2d");
  J.set$width$x($.canvas, 1024);
  J.set$height$x($.canvas, 2016);
  $.TILE_SIZE = 32;
  $.tileCanvas = $._doc.querySelector("#tile");
  $._ctxTile = J.getContext$1$x($.canvas, "2d");
  J.set$width$x($.tileCanvas, $.TILE_SIZE);
  J.set$height$x($.tileCanvas, $.TILE_SIZE);
  $.image = W._ElementFactoryProvider_createElement_tag("img", null);
  $.image = $._doc.createElement("img");
  J.set$src$x($.image, "assets/tileset.png");
  t1 = J.get$onLoad$x($.image);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new X.main_closure(), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  $.imageTile = W._ElementFactoryProvider_createElement_tag("img", null);
  $.imageTile = $._doc.createElement("img");
  J.set$src$x($.imageTile, "assets/tileset.png");
  $.divX = $._doc.querySelector("#divX");
  $.divY = $._doc.querySelector("#divY");
  t2 = document;
  C.EventStreamProvider_mousedown.forTarget$2$useCapture;
  t2 = new W._EventStream(t2, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, X.mousePressed$closure, t2._useCapture);
...
mousePressed: function(e) {
  ...
  if (t3 == null)
    throw H.iae(t3);
  x = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2 / t3)) - 1;
  t1 = new W.Point(t1.get$_pageX(e), t1.get$_pageY(e)).y;
  t3 = $.TILE_SIZE;
  if (t1 == null)
    throw t1.$div();
  if (t3 == null)
    throw H.iae(t3);
  y = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1 / t3)) - 1;
  t3 = $._ctxTile;
  t1 = $.TILE_SIZE;
  J.clearRect$4$x(t3, 0, 0, t1, t1);
  t1 = $._ctxTile;
  t3 = $.imageTile;
  t2 = $.TILE_SIZE;
  if (t2 == null)
    throw H.iae(t2);
  J.drawImageToRect$3$sourceRect$x(t1, t3, new W.Rect(0, 0, t2, t2), new W.Rect(x * t2, y * t2, t2, t2));
  $.divX.textContent = "X:" + C.JSNumber_methods.toString$0(x);
  $.divY.textContent = "Y:" + C.JSNumber_methods.toString$0(y);
},

update: function() {
  var t1, t2, t3, t4, cols, rows, x, y;
  t1 = $.canvas;
  ...
  for (x = 1; x < cols; ++x) {
    ...
    if (t2 == null)
      throw H.iae(t2);
    J.moveTo$2$x(t1, x * t2, 0);
    t2 = $._ctx;
    t1 = $.TILE_SIZE;
    if (t1 == null)
      throw H.iae(t1);
    J.lineTo$2$x(t2, x * t1, J.get$height$x($.canvas));
    J.stroke$0$x($._ctx);
  }
  for (y = 1; y < rows; ++y) {
    t1 = $._ctx;
    ...
    if (t2 == null)
      throw H.iae(t2);
    J.moveTo$2$x(t1, 0, y * t2);
    t2 = $._ctx;
    t1 = J.get$width$x($.canvas);
    t3 = $.TILE_SIZE;
    if (t3 == null)
      throw H.iae(t3);
    J.lineTo$2$x(t2, t1, y * t3);
    J.stroke$0$x($._ctx);
  }
},
...
init.globalFunctions.mousePressed$closure = X.mousePressed$closure = new X.Closure$mousePressed(X.mousePressed, "mousePressed$closure");
...
// Native classes
H.defineNativeMethods("DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList", J.Interceptor);
