...
["", "imageutil.dart", , X, {
  ...
  main: [function() {
    ...
    t1 = $._doc.createElement("img", null);
    $.image = t1;
    J.set$src$x(t1, "assets/tileset/tileset.png");
    t1 = J.get$onLoad$x($.image);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(X.mousePressed$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  mousePressed: [function(e) {
    ...
    if (typeof t3 !== "number")
      return H.iae(t3);
    x = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t2 / t3)) - 1;
    t1 = t1.get$client(e);
    t1 = t1.get$y(t1);
    t3 = $.TILE_SIZE;
    if (typeof t1 !== "number")
    ...
    if (typeof t3 !== "number")
      return H.iae(t3);
    y = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t1 / t3)) - 1;
    t3 = $._ctxTile;
    t1 = $.TILE_SIZE;
    ...
    t3 = $.imageTile;
    t2 = $.TILE_SIZE;
    t2 = P.Rectangle$(0, 0, t2, t2, null);
    t4 = $.TILE_SIZE;
    if (typeof t4 !== "number")
      return H.iae(t4);
    J.drawImageToRect$3$sourceRect$x(t1, t3, t2, P.Rectangle$(x * t4, y * t4, t4, t4, null));
    $.divX.textContent = "X:" + C.JSInt_methods.toString$0(x);
    $.divY.textContent = "Y:" + C.JSInt_methods.toString$0(y);
  }, "call$1", "mousePressed$closure", 2, 0, 9],
  update: function() {
    var t1, t2, cols, rows, x, y, t3;
