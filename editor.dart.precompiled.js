...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "CanvasRenderingContext;lineWidth},strokeStyle}",
...
["", "editor.dart", , E, {
  ...
  main: [function() {
    ...
    E.loadTileSet();
    E.initTabs();
    t1 = $._doc.querySelector("#tile");
    $.tileCanvas = t1;
    t1 = J.getContext$1$x(t1, "2d");
    $._ctxTile = t1;
    J.set$strokeStyle$x(t1, "#000");
    J.set$lineWidth$x($._ctxTile, 1);
    J.set$width$x($.tileCanvas, 32);
    J.set$height$x($.tileCanvas, 32);
    $.imageTile = W.ImageElement_ImageElement(32, "assets/tileset/tileset.png", 32);
    J.strokeRect$4$x($._ctxTile, 0, 0, 32, 32);
    $.tileSelected = K.Tile$(0, 0, 0);
    t1 = J.get$onMouseDown$x($.tilesetCanvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(E.tilesetPressed$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    E.layerSelection();
    E.toolSelection();
    $.maps = H.setRuntimeTypeInfo([], [E.EditorMap]);
    m1 = new E.EditorMap(null, null, null, null, null, null, null, null, null, null, null);
    m1.EditorMap$3("Map 001", 30, 20);
    t1 = $._doc.querySelector("#map");
    $.mapCanvas = t1;
    $.mapCtx = J.getContext$1$x(t1, "2d");
    ...
    m1._ctx = t2;
    m1.canvas = t3;
    J.set$width$x(t3, m1.widthTiles * 32);
    J.set$height$x(m1.canvas, m1.heightTiles * 32);
    J.set$strokeStyle$x(t2, "#000");
    t2.lineWidth = 1;
    m1.loadGraphic$1("assets/tileset/tileset.png");
    $.maps.push(m1);
    E.drawMapsList();
    E.loadMapSelection();
  ...
  initTabs: function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.initTabs_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  layerSelection: function() {
    var layers, t1;
    layers = $._doc.querySelector("#ulLayers");
    t1 = J.get$onClick$x(layers);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.layerSelection_closure(layers)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  toolSelection: function() {
    var toolsButtons, t1;
    toolsButtons = $._doc.querySelector("#toolset");
    t1 = J.get$onClick$x(toolsButtons);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.toolSelection_closure(toolsButtons)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x($._doc.querySelector("#generateMap"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.toolSelection_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x($._doc.querySelector("#loadJson"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.toolSelection_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  navigationHideAll: function() {
    for (var t1 = J.get$children$x($.navigation), t1 = t1.get$iterator(t1); t1.moveNext$0();)
      J.get$classes$x(t1.__internal$_current).remove$1(0, "active");
    for (t1 = J.get$children$x($.windows), t1 = t1.get$iterator(t1); t1.moveNext$0();)
      J.get$classes$x(t1.__internal$_current).add$1(0, "hide");
  },
  drawMapsList: function() {
    var ul, t1, t2, m, li;
    ul = $._doc.querySelector("#mapWindow ul.list-group");
    for (t1 = $.maps, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = J.getInterceptor$x(ul); t1.moveNext$0();) {
      m = t1.__internal$_current;
      li = W.Element_Element$html("<li class=\"list-group-item\"><span class=\"badge\">" + C.JSInt_methods.toString$0(m.get$widthTiles()) + " x " + C.JSInt_methods.toString$0(m.heightTiles) + "</span>" + m.name + "</li>", null, null);
      t2.get$children(ul).add$1(0, li);
    }
  },
  loadMapSelection: function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new E.loadMapSelection_closure(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onMouseDown$x($.mapCanvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new E.loadMapSelection_closure0(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onMouseMove$x($.mapCanvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new E.loadMapSelection_closure1()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  },
  loadTileSet: function() {
    var t1 = $._doc.querySelector("#tileset");
    $.tilesetCanvas = t1;
    t1 = J.getContext$1$x(t1, "2d");
    $._ctx = t1;
    J.set$strokeStyle$x(t1, "#000");
    J.set$lineWidth$x($._ctx, 1);
    J.set$width$x($.tilesetCanvas, 1024);
    J.set$height$x($.tilesetCanvas, 2016);
    $.tileElement = $._doc.querySelector("#tilesetCont");
    t1 = J.get$width$x($.tilesetCanvas);
    t1 = W.ImageElement_ImageElement(J.get$height$x($.tilesetCanvas), "assets/tileset/tileset.png", t1);
    $.image = t1;
    t1 = J.get$onLoad$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.loadTileSet_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  tilesetPressed: [function(e) {
    var t1, t2, t3, x, y;
    ...
    t3 = $.tileElement;
    t3.toString;
    t3 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.scrollLeft));
    if (typeof t2 !== "number")
      return t2.$add();
    x = C.JSNumber_methods.toInt$0(Math.ceil((t2 + t3) / 32)) - 1;
    t1 = t1.get$client(e);
    t1 = t1.get$y(t1);
    t3 = $.tileElement;
    t3.toString;
    t3 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.scrollTop));
    if (typeof t1 !== "number")
      return t1.$add();
    y = C.JSNumber_methods.toInt$0(Math.ceil((t1 + t3) / 32)) - 1;
    $.tileSelected = K.Tile$(x, y, 0);
    J.clearRect$4$x($._ctxTile, 0, 0, 32, 32);
    J.drawImageToRect$3$sourceRect$x($._ctxTile, $.imageTile, P.Rectangle$(0, 0, 32, 32, null), P.Rectangle$(x * 32, y * 32, 32, 32, null));
    J.strokeRect$4$x($._ctxTile, 0, 0, 32, 32);
  }, "call$1", "tilesetPressed$closure", 2, 0, 12],
  loadTileset: function() {
    var t1, cols, rows, x, y;
    t1 = J.get$width$x($.image);
    if (typeof t1 !== "number")
      return t1.$div();
    cols = t1 / 32;
    t1 = J.get$height$x($.image);
    if (typeof t1 !== "number")
      return t1.$div();
    rows = t1 / 32;
    J.drawImage$3$x($._ctx, $.image, 0, 0);
    for (x = 1; x < cols; ++x) {
      t1 = x * 32;
      J.moveTo$2$x($._ctx, t1, 0);
      J.lineTo$2$x($._ctx, t1, J.get$height$x($.image));
      J.stroke$0$x($._ctx);
    }
    for (y = 1; y < rows; ++y) {
      t1 = y * 32;
      J.moveTo$2$x($._ctx, 0, t1);
      J.lineTo$2$x($._ctx, J.get$width$x($.image), t1);
      J.stroke$0$x($._ctx);
    }
  },
  initTabs_closure: {
    ...
    call$1: function(e) {
      ...
      elem = t1.get$toElement(e);
      t1 = J.get$dataset$x(elem);
      option = t1._attributes._element.getAttribute("data-" + t1._toHyphenedName$1("option"));
      E.navigationHideAll();
      J.get$classes$x(elem.parentElement).add$1(0, "active");
      switch (option) {
        case "draw":
  ...
  layerSelection_closure: {
    ...
    call$1: function(e) {
      ...
      t1 = J.getInterceptor$x(e);
      t1.preventDefault$0(e);
      for (t2 = J.get$children$x(this.layers_0), t2 = t2.get$iterator(t2); t2.moveNext$0();)
        J.get$classes$x(t2.__internal$_current).remove$1(0, "active");
      elem = t1.get$toElement(e);
      J.get$classes$x(elem.parentElement).add$1(0, "active");
      t1 = J.get$dataset$x(elem);
      $.currentLayer = H.Primitives_parseInt(t1._attributes._element.getAttribute("data-" + t1._toHyphenedName$1("layer")), null, null);
    }
  },
  toolSelection_closure: {
    "^": "Closure:24;toolsButtons_0",
    call$1: function(e) {
      var t1, t2, elem;
      t1 = J.getInterceptor$x(e);
      t1.preventDefault$0(e);
      for (t2 = J.get$children$x(this.toolsButtons_0), t2 = t2.get$iterator(t2); t2.moveNext$0();)
        J.get$classes$x(t2.__internal$_current).remove$1(0, "active");
      elem = t1.get$toElement(e);
      J.get$classes$x(elem).add$1(0, "active");
      $.currentTool = elem.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(elem))._toHyphenedName$1("tool"));
    }
  },
  toolSelection_closure0: {
    ...
    call$1: function(e) {
      ...
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      jsonData = C.JsonCodec_null_null.encode$1(t1[0].toJson$0());
  ...
  toolSelection_closure1: {
    ...
    call$1: function(e) {
      var parsedJson, t1;
      parsedJson = C.JsonCodec_null_null.decode$1(J.get$value$x($._doc.querySelector("#genJsonTextArea")));
      t1 = $.maps;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1[0].loadMap$1(parsedJson);
    }
  },
  loadMapSelection_closure: {
    "^": "Closure:24;box_0",
    call$1: function(e) {
      var t1, t2, t3, x, y, iX, t4, iY, fX, fY, curMap, i;
      t1 = J.getInterceptor$x(e);
      t2 = t1.get$client(e);
      t2 = t2.get$x(t2);
      t3 = $.mapElement;
      ...
      if (typeof t2 !== "number")
        return t2.$add();
      x = C.JSNumber_methods.toInt$0(Math.ceil((t2 + t3 - 360) / 32));
      t1 = t1.get$client(e);
      t1 = t1.get$y(t1);
      t3 = $.mapElement;
      t3.toString;
      ...
      if (typeof t1 !== "number")
        return t1.$add();
      y = C.JSNumber_methods.toInt$0(Math.ceil((t1 + t3 - 10) / 32));
      t1 = this.box_0;
      t2 = t1.dragX_0;
      if (t2 !== x || t1.dragY_1 !== y) {
        if (typeof t2 !== "number")
          return t2.$gt();
        t3 = t2 > x;
        if (t3)
        ...
        for (e = iX; e < fX; ++e)
          for (i = iY; i < fY; ++i) {
            ...
            if (t1 === "pencil") {
              t1 = $.tileSelected;
              curMap.setTile$5(e, i, t1.x, t1.y, t2);
            } else
              curMap.setTile$5(e, i, 0, 0, t2);
          }
        curMap.reDraw$0();
      }
    }
  ...
  loadMapSelection_closure0: {
    ...
    call$1: function(e) {
      ...
      if (typeof t2 !== "number")
        return t2.$add();
      x = C.JSNumber_methods.toInt$0(Math.ceil((t2 + t3 - 360) / 32)) - 1;
      t1 = t1.get$client(e);
      t1 = t1.get$y(t1);
      t3 = $.mapElement;
      t3.toString;
      ...
      if (typeof t1 !== "number")
        return t1.$add();
      y = C.JSNumber_methods.toInt$0(Math.ceil((t1 + t3 - 10) / 32)) - 1;
      t3 = this.box_0;
      t3.dragX_0 = x;
      t3.dragY_1 = y;
      t3 = $.maps;
      ...
      if (t1 === "pencil") {
        t1 = $.tileSelected;
        curMap.setTile$5(x, y, t1.x, t1.y, t2);
      } else
        curMap.setTile$5(x, y, 0, 0, t2);
      curMap.reDraw$0();
    }
  },
  loadMapSelection_closure1: {
    ...
    call$1: function(e) {
      ...
      if (typeof t2 !== "number")
        return t2.$add();
      t3 = C.JSNumber_methods.toInt$0(Math.ceil((t2 + t3 - 360) / 32));
      t1 = t1.get$client(e);
      t1 = t1.get$y(t1);
      t2 = $.mapElement;
      t2.toString;
      t2 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.scrollTop));
      if (typeof t1 !== "number")
        return t1.$add();
      t2 = C.JSNumber_methods.toInt$0(Math.ceil((t1 + t2 - 10) / 32));
      t1 = $.maps;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      curMap = t1[0];
      t1 = curMap.mouseSelector;
      t1.x = t3 - 1;
      t1.y = t2 - 1;
      curMap.reDraw$1(true);
    }
  },
  loadTileSet_closure: {
    "^": "Closure:14;",
    call$1: function(value) {
      return E.loadTileset();
    }
  }
},
1],
["editorMap", "editor/editorMap.dart", , E, {
  "^": "",
  EditorMap: {
    "^": "Object;_doc,_ctx,canvas,mapImage,name,widthTiles<,heightTiles,layer1,layer2,layer3,mouseSelector",
    loadGraphic$1: function(src) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.EditorMap_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    ...
    reDraw$1: function(drawSelector) {
      var e, t1, i, t2, tile, t3, t4, t5, t6, t7;
      J.strokeRect$4$x(this._ctx, 0, 0, this.widthTiles * 32, this.heightTiles * 32);
      for (e = 0; e < this.heightTiles; ++e)
        for (t1 = e * 32, i = 0; i < this.widthTiles; ++i) {
          t2 = this.layer1.m;
          if (i >= t2.length)
            return H.ioore(t2, i);
          t2 = t2[i];
          ...
          t3 = this.mapImage;
          t4 = i * 32;
          t5 = new P.Rectangle(t4, t1, 32, 32);
          ...
          if (t2 !== 0) {
            t3 = this._ctx;
            t5 = this.mapImage;
            t6 = new P.Rectangle(t4, t1, 32, 32);
            t6.$builtinTypeInfo = [null];
            t7 = t2.get$xImg();
            t2 = t2.yImg;
            t2 = new P.Rectangle(t7, t2, 32, 32);
            t2.$builtinTypeInfo = [null];
            J.drawImageToRect$3$sourceRect$x(t3, t5, t6, t2);
          }
          t2 = this.layer3.m;
          if (i >= t2.length)
            return H.ioore(t2, i);
          ...
          if (t2 !== 0) {
            t3 = this._ctx;
            t5 = this.mapImage;
            t4 = new P.Rectangle(t4, t1, 32, 32);
      ...
      if (drawSelector) {
        ...
        t1 = this._ctx;
        t2 = this.mouseSelector;
        J.strokeRect$4$x(t1, t2.x * 32, t2.y * 32, 32, 32);
      }
    },
    reDraw$0: function() {
    ...
    loadMap$1: function(mapData) {
      ...
      t1 = J.getInterceptor$asx(nLayer1);
      t2 = J.getInterceptor$asx(nLayer3);
      t3 = J.getInterceptor$asx(nLayer2);
      i = 0;
      while (true) {
        t4 = t1.get$length(nLayer1);
        if (typeof t4 !== "number")
          return H.iae(t4);
        if (!(i < t4))
          break;
        e = 0;
        while (true) {
          t4 = J.get$length$asx(t1.$index(nLayer1, C.JSInt_methods.toString$0(i)));
          if (typeof t4 !== "number")
            return H.iae(t4);
          if (!(e < t4))
            break;
          t4 = J.$index$asx(J.$index$asx(t1.$index(nLayer1, C.JSInt_methods.toString$0(i)), C.JSInt_methods.toString$0(e)), "x");
          t5 = J.$index$asx(J.$index$asx(t1.$index(nLayer1, C.JSInt_methods.toString$0(i)), C.JSInt_methods.toString$0(e)), "y");
          ...
          if (!!J.getInterceptor(J.$index$asx(t3.$index(nLayer2, C.JSInt_methods.toString$0(i)), C.JSInt_methods.toString$0(e))).$isMap) {
            ...
            t20 = 0;
          if (!!J.getInterceptor(J.$index$asx(t2.$index(nLayer3, C.JSInt_methods.toString$0(i)), C.JSInt_methods.toString$0(e))).$isMap) {
            t4 = J.$index$asx(J.$index$asx(t2.$index(nLayer3, C.JSInt_methods.toString$0(i)), C.JSInt_methods.toString$0(e)), "x");
            t5 = J.$index$asx(J.$index$asx(t2.$index(nLayer3, C.JSInt_methods.toString$0(i)), C.JSInt_methods.toString$0(e)), "y");
...
["matrix", "helpers/matrix.dart", , T, {
  ...
  Matrix: {
    "^": "Object;m,rows,cols",
    toJson$0: function() {
      var map, i, e, t1, t2, t3;
      map = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      for (i = 0; i < this.cols; ++i) {
        map.$indexSet(0, C.JSInt_methods.toString$0(i), P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        for (e = 0; e < this.rows; ++e) {
          ...
          if (typeof t1 === "number" && Math.floor(t1) === t1) {
            t1 = map.$index(0, C.JSInt_methods.toString$0(i));
            t2 = C.JSInt_methods.toString$0(e);
            t3 = this.m;
            if (i >= t3.length)
              return H.ioore(t3, i);
            t3 = t3[i];
            if (e >= t3.length)
              return H.ioore(t3, e);
            J.$indexSet$ax(t1, t2, J.toString$0(t3[e]));
          } else {
            t1 = map.$index(0, C.JSInt_methods.toString$0(i));
            t2 = C.JSInt_methods.toString$0(e);
            t3 = this.m;
            ...
            if (e >= t3.length)
              return H.ioore(t3, e);
            J.$indexSet$ax(t1, t2, t3[e].toJson$0());
          }
        }
      }
      return map;
...
function dart_precompiled($collectedClasses) {
  ...
  function initTabs_closure() {
  }
  initTabs_closure.builtin$cls = "initTabs_closure";
  if (!"name" in initTabs_closure)
    initTabs_closure.name = "initTabs_closure";
  $desc = $collectedClasses.initTabs_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initTabs_closure.prototype = $desc;
  function layerSelection_closure(layers_0) {
    this.layers_0 = layers_0;
  }
  layerSelection_closure.builtin$cls = "layerSelection_closure";
  if (!"name" in layerSelection_closure)
    layerSelection_closure.name = "layerSelection_closure";
  $desc = $collectedClasses.layerSelection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  layerSelection_closure.prototype = $desc;
  function toolSelection_closure(toolsButtons_0) {
    this.toolsButtons_0 = toolsButtons_0;
  }
  toolSelection_closure.builtin$cls = "toolSelection_closure";
  if (!"name" in toolSelection_closure)
    toolSelection_closure.name = "toolSelection_closure";
  $desc = $collectedClasses.toolSelection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  toolSelection_closure.prototype = $desc;
  function toolSelection_closure0() {
  }
  toolSelection_closure0.builtin$cls = "toolSelection_closure0";
  if (!"name" in toolSelection_closure0)
    toolSelection_closure0.name = "toolSelection_closure0";
  $desc = $collectedClasses.toolSelection_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  toolSelection_closure0.prototype = $desc;
  function toolSelection_closure1() {
  }
  toolSelection_closure1.builtin$cls = "toolSelection_closure1";
  if (!"name" in toolSelection_closure1)
    toolSelection_closure1.name = "toolSelection_closure1";
  $desc = $collectedClasses.toolSelection_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  toolSelection_closure1.prototype = $desc;
  function loadMapSelection_closure(box_0) {
    this.box_0 = box_0;
  }
  loadMapSelection_closure.builtin$cls = "loadMapSelection_closure";
  if (!"name" in loadMapSelection_closure)
    loadMapSelection_closure.name = "loadMapSelection_closure";
  $desc = $collectedClasses.loadMapSelection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadMapSelection_closure.prototype = $desc;
  function loadMapSelection_closure0(box_0) {
    this.box_0 = box_0;
  }
  loadMapSelection_closure0.builtin$cls = "loadMapSelection_closure0";
  if (!"name" in loadMapSelection_closure0)
    loadMapSelection_closure0.name = "loadMapSelection_closure0";
  $desc = $collectedClasses.loadMapSelection_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadMapSelection_closure0.prototype = $desc;
  function loadMapSelection_closure1() {
  }
  loadMapSelection_closure1.builtin$cls = "loadMapSelection_closure1";
  if (!"name" in loadMapSelection_closure1)
    loadMapSelection_closure1.name = "loadMapSelection_closure1";
  $desc = $collectedClasses.loadMapSelection_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadMapSelection_closure1.prototype = $desc;
  function loadTileSet_closure() {
  }
  loadTileSet_closure.builtin$cls = "loadTileSet_closure";
  if (!"name" in loadTileSet_closure)
    loadTileSet_closure.name = "loadTileSet_closure";
  $desc = $collectedClasses.loadTileSet_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadTileSet_closure.prototype = $desc;
  function EditorMap(_doc, _ctx, canvas, mapImage, name, widthTiles, heightTiles, layer1, layer2, layer3, mouseSelector) {
    this._doc = _doc;
    this._ctx = _ctx;
    this.canvas = canvas;
    ...
    this.layer2 = layer2;
    this.layer3 = layer3;
    this.mouseSelector = mouseSelector;
  }
  EditorMap.builtin$cls = "EditorMap";
  if (!"name" in EditorMap)
    EditorMap.name = "EditorMap";
  $desc = $collectedClasses.EditorMap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorMap.prototype = $desc;
  EditorMap.prototype.get$widthTiles = function() {
    return this.widthTiles;
  };
  function EditorMap_loadGraphic_closure(this_0) {
    this.this_0 = this_0;
  }
  EditorMap_loadGraphic_closure.builtin$cls = "EditorMap_loadGraphic_closure";
  if (!"name" in EditorMap_loadGraphic_closure)
    EditorMap_loadGraphic_closure.name = "EditorMap_loadGraphic_closure";
  $desc = $collectedClasses.EditorMap_loadGraphic_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorMap_loadGraphic_closure.prototype = $desc;
