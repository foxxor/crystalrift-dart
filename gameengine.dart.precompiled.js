...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|TextMetrics"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["animation", "core/animation.dart", , L, {
  "^": "",
  Animation: {
    "^": "Object;_animation$_doc,_animation$_ctx,canvas,animationImage,scene,curPosPx<,animationFrame",
    ...
    }, "call$0", "get$updateFrame", 0, 0, 1],
    update$0: function() {
      var t1, frameX, frameY;
      t1 = this.animationFrame;
      frameX = C.JSInt_methods.$mod(t1, 5);
      frameY = C.JSNumber_methods.toInt$0(Math.floor(t1 / 5));
      J.drawImageScaledFromSource$9$x(this._animation$_ctx, this.animationImage, 192 * frameX, 195 * frameY, 192, 195, J.$sub$n(this.curPosPx.x, this.scene.displayPxX), J.$sub$n(this.curPosPx.y, this.scene.displayPxY), 32, 42);
    },
    loadGraphic$1: function(src) {
      var t1;
      this.animationImage = W._ElementFactoryProvider_createElement_tag("img", null);
      t1 = this._animation$_doc.createElement("img", null);
      this.animationImage = t1;
      J.set$src$x(t1, src);
      t1 = J.get$onLoad$x(this.animationImage);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.Animation_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
...
["character", "core/character.dart", , Z, {
  "^": "",
  Character: {
    "^": "Object;_character$_doc,_character$_ctx,canvas,characterImage,curPos<,curPosPx<,frame,faceDir,selectedChar,randomMovement,phasable<,speed,trigger,scene,message,offsetX,offsetY,acDelta,lastUpdateTime",
    ...
    loadGraphic$1: function(src) {
      ...
      t1 = this._character$_doc.createElement("img", null);
      this.characterImage = t1;
      J.set$src$x(t1, src);
      t1 = J.get$onLoad$x(this.characterImage);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.Character_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    isMoving$0: function() {
    ...
    update$0: function() {
      ...
      if (this.isMoving$0()) {
        ...
        if (J.$gt$n(J.$mul$ns(this.curPos.y, 32), this.curPosPx.y)) {
          this.faceDirection$1(1);
          t1 = this.curPosPx;
          t1.y = P.min(J.$add$ns(t1.y, distance), J.$mul$ns(this.curPos.y, 32));
        }
        if (J.$gt$n(J.$mul$ns(this.curPos.x, 32), this.curPosPx.x)) {
          this.faceDirection$1(3);
          t1 = this.curPosPx;
          t1.x = P.min(J.$add$ns(t1.x, distance), J.$mul$ns(this.curPos.x, 32));
        }
        if (J.$lt$n(J.$mul$ns(this.curPos.y, 32), this.curPosPx.y)) {
          this.faceDirection$1(0);
          t1 = this.curPosPx;
          t1.y = P.max(J.$sub$n(t1.y, distance), J.$mul$ns(this.curPos.y, 32));
        }
        if (J.$lt$n(J.$mul$ns(this.curPos.x, 32), this.curPosPx.x)) {
          this.faceDirection$1(2);
          t1 = this.curPosPx;
          t1.x = P.max(J.$sub$n(t1.x, distance), J.$mul$ns(this.curPos.x, 32));
        }
        if (++this.frame > 2)
          this.frame = 0;
      } else
        this.stopMove$0();
      J.drawImageToRect$3$sourceRect$x(this._character$_ctx, this.characterImage, P.Rectangle$(J.$sub$n(this.curPosPx.x, this.scene.displayPxX), J.$sub$n(this.curPosPx.y, this.scene.displayPxY), 32, 32, null), P.Rectangle$(J.$mul$ns(J.$add$ns(J.$mul$ns(this.selectedChar, 3), this.frame), 32), 32 * this.faceDir, 32, 32, null));
    },
    Character$8: function(_doc, _ctx, canvas, curPos, charSprite, scene, message, speed) {
      ...
      this.speed = speed;
      this.curPos = curPos;
      t1 = J.$mul$ns(curPos.x, 32);
      t2 = J.$mul$ns(curPos.y, 32);
    ...
    static: {Character$: function(_doc, _ctx, canvas, curPos, charSprite, scene, message, speed) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "CanvasRenderingContext;fillStyle},globalAlpha},globalCompositeOperation},shadowOffsetX}",
  ...
  Document: {
    "^": "Node;",
    get$onLoad: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_load._eventType, false), [null]);
    },
  ...
  HttpRequestEventTarget: {
    "^": "EventTarget;",
    get$onLoad: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_load0._eventType, false), [null]);
    },
...
["dart.math", "dart:math", , P, {
  ...
  _RectangleBase: {
    ...
    get$hashCode: function(_) {
      ...
      t2 = P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(0, t1), t4), t5), t2);
...
["entity", "core/entity.dart", , S, {
  ...
  Entity: {
    ...
    loadGraphic$1: function(src) {
      ...
      t1 = this._entity$_doc.createElement("img", null);
      this.itemImage = t1;
      J.set$src$x(t1, src);
      t1 = J.get$onLoad$x(this.itemImage);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new S.Entity_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    move$1: function(face) {
      var deltaY, deltaX, t1, t2;
      if (!this.scene.shallPass$2(face, this))
        return false;
      deltaY = J.abs$0$n(J.$sub$n(J.$mul$ns(this.curPos.y, 32), this.curPosPx.y));
    ...
    update$0: function() {
      ...
      t2 = this.itemImage;
      t3 = P.Rectangle$(J.$sub$n(this.curPosPx.x, this.scene.displayPxX), J.$sub$n(this.curPosPx.y, this.scene.displayPxY), 32, 32, null);
      t4 = this.tile;
      J.drawImageToRect$3$sourceRect$x(t1, t2, t3, P.Rectangle$(t4.xImg, t4.yImg, 32, 32, null));
    },
...
["", "gameengine.dart", , B, {
  ...
  main: [function() {
    ...
    t1 = window.document;
    $._doc = t1;
    t1 = t1.querySelector("#canvas");
    $.canvas = t1;
    J.set$width$x(t1, 672);
    J.set$height$x($.canvas, 512);
    t1 = J.getContext$1$x($.canvas, "2d");
    $._ctx = t1;
    t2 = new A.Scene(null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    t2.Scene$3($._doc, t1, $.canvas);
    $.scene = t2;
    t2 = new R.WindowSet(null, null, null, null, null, null, null, null, null, null);
    t2.WindowSet$8($._doc, $._ctx, $.canvas, 0, 384, 672, 128, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum dictum lacus. Mauris metus urna, consectetur ut nulla in, ullamcorper vehicula mauris. Fusce aliquam sapien eu hendrerit euismod. Mauris dignissim non arcu sit amet egestas. Proin blandit nec tellus sit amet tristique. ");
    $.windowInfo = t2;
    B.setupKeys();
  ...
  update: [function(delta) {
    ...
    if (!t1.endOfLine)
      t1.update$0();
    C.Window_methods.get$animationFrame(window).then$1(B.update$closure());
  }, "call$1", "update$closure", 2, 0, 9],
  setupKeys: function() {
    var t1 = J.get$onKeyDown$x($.canvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.setupKeys_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onKeyUp$x($.canvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.setupKeys_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  setupKeys_closure: {
    "^": "Closure:11;",
    call$1: function(e) {
...
["mapset", "core/mapset.dart", , M, {
  "^": "",
  MapSet: {
    "^": "Object;_mapset$_doc,_mapset$_ctx,canvas,mapsetImage,structuresData,scene,mapset,mapset2,mapset3",
    loadGraphic$1: function(src) {
      var t1;
      this.mapsetImage = W._ElementFactoryProvider_createElement_tag("img", null);
      t1 = this._mapset$_doc.createElement("img", null);
      this.mapsetImage = t1;
      J.set$src$x(t1, src);
      t1 = J.get$onLoad$x(this.mapsetImage);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.MapSet_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    ...
    update$0: function() {
      var e, t1, i, t2, tile, t3, t4, t5, t6, t7;
      for (e = 0; e < 24; ++e)
        for (t1 = e * 32, i = 0; i < 30; ++i) {
          ...
          t6 = tile.get$xImg();
          t7 = tile.yImg;
          t6 = new P.Rectangle(t6, t7, 32, 32);
          ...
          if (t2 !== 0) {
            ...
            if (typeof t6 !== "number")
              return H.iae(t6);
            t4 = new P.Rectangle(t4 - t7, t1 - t6, 32, 32);
            t4.$builtinTypeInfo = [null];
            t6 = t2.get$xImg();
            t2 = t2.yImg;
            t2 = new P.Rectangle(t6, t2, 32, 32);
            t2.$builtinTypeInfo = [null];
            J.drawImageToRect$3$sourceRect$x(t3, t5, t4, t2);
          }
        }
    },
...
["matrix", "helpers/matrix.dart", , T, {
  ...
  Matrix: {
    ...
    Matrix$2: function(cols, rows) {
      ...
      this.rows = rows;
      this.cols = cols;
      t1 = H.setRuntimeTypeInfo(Array(cols), [P.List]);
      this.m = t1;
      for (i = 0; i < cols; ++i) {
        t2 = Array(rows);
        if (i >= t1.length)
    ...
    static: {Matrix$: function(cols, rows) {
...
["particle", "core/particle.dart", , D, {
  "^": "",
  Particle: {
    "^": "Object;_particle$_doc,_particle$_ctx,canvas,particles,particlesCoords,particlesAlpha,effect,curPosPx<,frame,maxParticles,width,height>,alpha,scene,blendType,color",
    start$0: function(_) {
      P.Timer_Timer(C.Duration_60000, this.get$updateAnimation());
    },
    updateAnimation$0: [function() {
      var t1, coordIte, i, c, cAlpha, t2, number, negative, t3;
      t1 = this.particlesCoords;
      coordIte = new H.ListIterator(t1, t1.length, 0, null);
      ++this.frame;
      for (i = 0; coordIte.moveNext$0();) {
        c = coordIte._current;
        t1 = this.effect;
        if (t1 === "poison" || t1 === "smoke") {
          ...
          if (typeof cAlpha !== "number")
            return cAlpha.$le();
          t1 = cAlpha <= 0.05 || J.$le$n(J.get$y$x(c), this.curPosPx.y);
          t2 = J.getInterceptor$x(c);
          if (t1) {
            cAlpha = this.alpha;
            t2.set$y(c, J.$sub$n(J.$add$ns(this.curPosPx.y, 32), 17));
            t2.set$x(c, J.$sub$n(J.$add$ns(this.curPosPx.x, C.JSNumber_methods.toInt$0(Math.floor(16))), 5));
          } else {
            number = C.C__JSRandom.nextInt$1(2);
            negative = C.C__JSRandom.nextBool$0();
            cAlpha -= number / 50;
            t2.set$y(c, J.$sub$n(t2.get$y(c), number));
            t1 = t2.get$x(c);
            t2.set$x(c, J.$add$ns(t1, negative ? number * -1 : number));
          }
          C.JSArray_methods.insert$2(this.particlesAlpha, i, cAlpha);
        } else if (t1 === "fire") {
          t1 = this.particlesAlpha;
          if (i >= t1.length)
            return H.ioore(t1, i);
          ...
          t3.set$x(c, J.$add$ns(t1, C.JSNumber_methods.toInt$0(Math.floor(32 * Math.cos(t2 + number)))));
          t2 = this.curPosPx.y;
          t1 = this.frame;
          t3.set$y(c, J.$add$ns(t2, C.JSNumber_methods.toInt$0(Math.floor(32 * Math.sin(t1 + number)))));
        }
        ++i;
      }
      this.start$0(0);
    }, "call$0", "get$updateAnimation", 0, 0, 1],
    update$0: function() {
      ...
      for (; partIte.moveNext$0();) {
        ...
        t1 = this.blendType;
        if (t1 != null) {
          J.set$globalCompositeOperation$x(this._particle$_ctx, t1);
          J.set$fillStyle$x(this._particle$_ctx, this.color);
        }
    ...
    loadGraphic$1: function(src) {
      var particleImage, t1, i, particleImageN, number, t2, coordinateN, nAlpha;
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new D.Particle_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      i = 0;
      while (true) {
        ...
        t1 = J.$add$ns(J.$add$ns(this.curPosPx.x, C.JSNumber_methods.toInt$0(Math.floor(16))), number);
...
["scene", "core/scene.dart", , A, {
  "^": "",
  Scene: {
    "^": "Object;_scene0$_doc,_scene0$_ctx,canvas,gameMap,chars,mainCharacter,entities,activeEvents,activeAnimations,particle,displayX,displayY,displayPxX,displayPxY",
    update$0: function() {
      var t1, t2, distance, charas, entitiesIte, animationsIte, eventIte;
      t1 = this.displayPxX;
      t2 = this.displayX;
      if (typeof t2 !== "number")
        return t2.$mul();
      if (t1 === t2 * 32) {
        ...
        t1 = true;
      if (t1 && this.mainCharacter.isMoving$0()) {
        distance = 2 * this.mainCharacter.speed;
        t1 = this.displayY;
        if (typeof t1 !== "number")
          return t1.$mul();
        t1 *= 32;
        ...
        if (t1 * 32 < t2) {
          ...
          if (typeof t1 !== "number")
            return t1.$add();
          this.displayX = P.max(C.JSNumber_methods.toInt$0(Math.floor((t1 + (32 - t2)) / 32)), this.displayX) - 1;
        }
      }
    ...
    loadEntities$1: [function(responseText) {
      ...
      for (; iteEntities.moveNext$0();) {
        ...
        tile.yImg = J.$mul$ns(t2, 32);
        tile.x = t3;
        tile.y = t2;
        tile.type = 0;
        item = new S.Entity(null, null, null, null, null, null, null, null, null, null, null);
        item.Entity$8(this._scene0$_doc, this._scene0$_ctx, this.canvas, coords, tile, this, t1.$index(i, "pushable"), 1);
        this.entities.push(item);
      }
    }, "call$1", "get$loadEntities", 2, 0, 21],
    ...
    }, "call$1", "get$loadCharacters", 2, 0, 21],
    ...
    shallPass$2: function(face, c) {
      ...
      if (face === 0) {
        ...
        newCoords = null;
      if (this.gameMap.nextToTile$3(c.get$curPos().x, c.get$curPos().y, face))
        return false;
      t1 = this.chars;
      charas = new H.ListIterator(t1, t1.length, 0, null);
      for (; charas.moveNext$0();) {
        ...
        if (!$char.get$phasable() && nextTo)
          return false;
      }
      t1 = this.mainCharacter;
      if (c !== t1) {
        nextTo = t1.curPos.nextToThis2$1(newCoords);
        if (!this.mainCharacter.phasable && nextTo)
          return false;
      }
      t1 = this.entities;
      entitiesIte = new H.ListIterator(t1, t1.length, 0, null);
    ...
    getCharacterInFront$0: function() {
      var t1, charas, $char, charFace;
      t1 = this.chars;
      charas = new H.ListIterator(t1, t1.length, 0, null);
      for (; charas.moveNext$0();) {
        $char = charas._current;
        charFace = $char.get$curPosPx().facingThis$2(this.mainCharacter.getCurrentDirection$0(), this.mainCharacter.curPosPx);
        if (charFace >= 0) {
    ...
    Scene$3: function(_doc, _ctx, canvas) {
      var t1, initCoor, initCoor2, animation, partCoor;
      this._scene0$_doc = _doc;
      this._scene0$_ctx = _ctx;
      this.canvas = canvas;
      t1 = new M.MapSet(null, null, null, null, null, null, null, null, null);
      t1.MapSet$4(_doc, _ctx, canvas, this);
      this.gameMap = t1;
      ...
      initCoor2.x = 384;
      initCoor2.y = 128;
      animation = new L.Animation(null, null, null, null, null, null, null);
      animation.Animation$6(_doc, _ctx, canvas, this, initCoor2, "fire_001");
      animation.startAnimation$0();
      partCoor = new L.Coordinate(null, null);
      partCoor.x = 384;
      partCoor.y = 224;
      t1 = new D.Particle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
      t1.Particle$6(_doc, _ctx, canvas, this, partCoor, "smoke");
      this.particle = t1;
      t1.start$0(0);
      t1 = H.setRuntimeTypeInfo([], [L.Animation]);
      this.activeAnimations = t1;
      t1.push(animation);
      this.mainCharacter = Z.Character$(_doc, _ctx, canvas, initCoor, 0, this, "", 1);
      this.chars = H.setRuntimeTypeInfo([], [Z.Character]);
      this.entities = H.setRuntimeTypeInfo([], [S.Entity]);
      this.displayX = 0;
      this.displayY = 0;
      this.displayPxX = 0;
      this.displayPxY = 0;
      this.activeEvents = H.setRuntimeTypeInfo([], [O.Action]);
...
["windowset", "core/windowset.dart", , R, {
  ...
  WindowSet: {
    ...
    update$0: function() {
      var t1, y, x, t2, t3, t4, t5, t6;
      J.save$0$x(this._ctx);
      J.set$globalAlpha$x(this._ctx, 0.7);
      J.drawImageScaledFromSource$9$x(this._ctx, this.windowImage, 0, 0, 64, 64, J.$add$ns(this.curPos.x, 9), J.$add$ns(this.curPos.y, 9), this.width - 18, this.height - 18);
      t1 = this.curPos;
      y = t1.y;
      for (x = t1.x, t1 = J.getInterceptor$ns(y); t2 = J.getInterceptor$n(x), t3 = t2.$le(x, this.width), t4 = this._ctx, t3; x = t2.$add(x, 64)) {
        t3 = this.windowImage;
        t5 = new P.Rectangle(x, y, 64, 64);
        t5.$builtinTypeInfo = [null];
        t6 = new P.Rectangle(0, 64, 64, 64);
        t6.$builtinTypeInfo = [null];
        J.drawImageToRect$3$sourceRect$x(t4, t3, t5, t6);
        t3 = this._ctx;
        t4 = this.windowImage;
        t5 = t1.$add(y, 64);
        t5 = new P.Rectangle(x, t5, 64, 64);
        t5.$builtinTypeInfo = [null];
        t6 = new P.Rectangle(0, 64, 64, 64);
        t6.$builtinTypeInfo = [null];
        J.drawImageToRect$3$sourceRect$x(t3, t4, t5, t6);
      }
      J.restore$0$x(t4);
      t1 = this._ctx;
      t2 = this.windowImage;
      t3 = this.curPos;
      J.drawImageToRect$3$sourceRect$x(t1, t2, P.Rectangle$(t3.x, t3.y, 9, 9, null), P.Rectangle$(64, 0, 9, 9, null));
      J.drawImageToRect$3$sourceRect$x(this._ctx, this.windowImage, P.Rectangle$(J.$sub$n(J.$add$ns(this.curPos.x, this.width), 8), this.curPos.y, 10, 9, null), P.Rectangle$(121, 0, 9, 9, null));
      t3 = this._ctx;
      t2 = this.windowImage;
      t1 = this.curPos;
      J.drawImageToRect$3$sourceRect$x(t3, t2, P.Rectangle$(t1.x, J.$sub$n(J.$add$ns(t1.y, this.height), 8), 9, 9, null), P.Rectangle$(64, 57, 9, 9, null));
      J.drawImageToRect$3$sourceRect$x(this._ctx, this.windowImage, P.Rectangle$(J.$sub$n(J.$add$ns(this.curPos.x, this.width), 9), J.$sub$n(J.$add$ns(this.curPos.y, this.height), 8), 10, 9, null), P.Rectangle$(121, 57, 9, 9, null));
      J.drawImageScaledFromSource$9$x(this._ctx, this.windowImage, 73, 0, 9, 9, J.$add$ns(this.curPos.x, 9), this.curPos.y, this.width - 18 + 1, 9);
      J.drawImageScaledFromSource$9$x(this._ctx, this.windowImage, 73, 0, 9, 9, J.$add$ns(this.curPos.x, 9), J.$sub$n(J.$add$ns(this.curPos.y, this.height), 9), this.width - 18, 9);
      t1 = this._ctx;
      t2 = this.windowImage;
      t3 = this.curPos;
      J.drawImageScaledFromSource$9$x(t1, t2, 64, 9, 9, 9, t3.x, J.$add$ns(t3.y, 9), 9, this.height - 18 + 1);
      J.drawImageScaledFromSource$9$x(this._ctx, this.windowImage, 64, 9, 9, 9, J.$sub$n(J.$add$ns(this.curPos.x, this.width), 9), J.$add$ns(this.curPos.y, 9), 9, this.height - 18 + 1);
      this.drawText$0();
    },
    drawText$0: function() {
      var x, y, t1, words, line, numLines, n, testLine, t2;
      ...
      for (line = "", numLines = 0, n = 0; n < words.length; ++n) {
        ...
        if (t1 > t2 - 40) {
          ...
          line = testLine;
        if (numLines >= 3 + this.startLine) {
          J.drawImageScaledFromSource$9$x(this._ctx, this.windowImage, 96, 65, 17, 16, J.$sub$n(J.$add$ns(this.curPos.x, this.width / 2), 25), J.$sub$n(J.$add$ns(this.curPos.y, this.height), 25), 20, 20);
          break;
        }
      }
      if (numLines < this.startLine)
    ...
    loadGraphic$1: function(src) {
      ...
      t1 = this._doc.createElement("img", null);
      this.windowImage = t1;
      J.set$src$x(t1, src);
      t1 = J.get$onLoad$x(this.windowImage);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.WindowSet_loadGraphic_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
...
function dart_precompiled($collectedClasses) {
  ...
  function Particle(_particle$_doc, _particle$_ctx, canvas, particles, particlesCoords, particlesAlpha, effect, curPosPx, frame, maxParticles, width, height, alpha, scene, blendType, color) {
  ...
  function Tile(xImg, yImg, type, x, y) {
    this.xImg = xImg;
    this.yImg = yImg;
    this.type = type;
    this.x = x;
  ...
  Tile.prototype.set$x = function(receiver, v) {
    return this.x = v;
  };
  Tile.prototype.get$y = function(receiver) {
    return this.y;
  };
  Tile.prototype.set$y = function(receiver, v) {
    return this.y = v;
  };
